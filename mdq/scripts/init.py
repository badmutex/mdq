...
def build_parser(p):
    ...
    p.add_argument('-t', '--time', type=int, help='Number of picoseconds to run each generation')
    p.add_argument('-o', '--outputfreq', type=float, help='Output frequency in picoseconds')
